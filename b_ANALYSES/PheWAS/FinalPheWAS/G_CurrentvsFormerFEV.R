...
#cd /homes/jbuchwal/PHESANT/PHEWAS_2Stage/FDR_final
...
WorkDir="/fs/projects/ukbb/jadwiga/PHESANT/PHEWAS_2Stage"
TraitDir="/fs/projects/ukbb/jadwiga/PHESANT/TRAIT/"
