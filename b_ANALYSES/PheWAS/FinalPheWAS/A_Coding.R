...
#3. By hand: I'll add a column get each of the unique codings and add them to the excel sheet in the relevant places.
	...
	#${PHESANTDir}/ukb_data_codes/data_codes/datacode-100538.tsv
	#coding	meaning
	#-7	None of the above
...
4. Merging List61Coding_edited.csv with reassignment information from ${PHESANTDir}/variable-info/data-coding-ordinal-info.txt
