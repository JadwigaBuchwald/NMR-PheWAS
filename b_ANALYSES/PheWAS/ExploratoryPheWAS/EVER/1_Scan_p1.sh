...
#First running part 1 (to check all runs smoothly),and then running parts 2-100 and 101-200.

#1) Running scan (not saving the derived phenotypes)
#2) Using SGE to actually get 200 parallel jobs. 

#Note:I manually created the directory "Results" under this directory
